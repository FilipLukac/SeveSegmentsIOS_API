...
- (void)viewDidLoad
{
	...
	SevenSegments *sevenString = [[SevenSegments alloc] initWithToken:@"7fa0a2c4-fead-11e3-b648-4061862b98a0" customerString:@"1234" :nil];
	...
	// Testing update user
	[sevenString update:@{@"last_name":@"Janko", @"first_name":@"hrasko"}];
